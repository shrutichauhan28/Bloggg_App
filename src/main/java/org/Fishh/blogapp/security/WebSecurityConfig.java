package org.Fishh.blogapp.security;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                .csrf(csrf -> csrf.disable())   // if enabled must use post method to logout and additional configuration needed
...
//                .antMatchers("/deletePost/**").hasRole("ADMIN")
                ...
                .logout(logout -> logout.logoutUrl("/logout").logoutSuccessUrl("/login?logout") // same as default implicit configuration
                        .permitAll())
